...
function renderInitialHTML() {
    ...
    const initialHTML = `  
        ...
        <div class="relleno">
            <div class="busqueda">
                ...
                <div class="acciones-grande">
                    <button class="exportar-excel btn origin"><i class='bx bxs-file'></i> <span>Descargar Excel</span></button>
        ...
        <div class="anuncio-botones">
            <button class="exportar-excel btn origin"><i class='bx bxs-file'></i> Descargar Excel</button>
