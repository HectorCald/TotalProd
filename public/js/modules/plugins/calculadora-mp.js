        ...
        <div class="registro-item" data-id="${registro.id}">
            <div class="header">
                ...
                <div class="info-header">
                    <span class="id-flotante"><span class="id">${registro.id}</span><span class="flotante-item ${registro.peso_final ? 'finalizado' : 'pendiente'}">${registro.peso_final ? 'Finalizado' : 'Pendiente'}</span></span>
                    <span class="detalle">${registro.nombre}</span>
                    <span class="pie">${registro.materia_prima}</span>
                </div>
            </div>
        </div>
    `).join('');
