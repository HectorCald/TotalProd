...
function renderMenu() {
    ...
    const menuL = `
        <div class="encabezado-lateral">
            <button class="btn" id="estatico" style="background: none;font-size: 16px; justify-content:flex-start; padding-left:10px; min-width:40px !important"><i class="fas fa-bars"></i><span style="color: var(--tercer-color);">Menu</span></button>
